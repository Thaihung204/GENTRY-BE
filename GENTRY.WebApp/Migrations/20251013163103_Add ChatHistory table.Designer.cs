...
namespace GENTRY.WebApp.Migrations
{
    ...
    [Migration("20251013163103_Add ChatHistory table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GENTRY.WebApp.Models.ChatHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GENTRY.WebApp.Models.Occasion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GENTRY.WebApp.Models.Weather", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GENTRY.WebApp.Models.ChatHistory", b =>
                {
                    b.HasOne("GENTRY.WebApp.Models.Outfit", "GeneratedOutfit")
                        .WithMany()
            ...
            modelBuilder.Entity("GENTRY.WebApp.Models.Outfit", b =>
                {
                    b.HasOne("GENTRY.WebApp.Models.Occasion", "Occasion")
                        .WithMany("Outfits")
                    ...
                    b.HasOne("GENTRY.WebApp.Models.Weather", "Weather")
                        .WithMany("Outfits")
